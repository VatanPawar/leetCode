// Last updated: 7/11/2025, 12:06:25 AM
class Solution {
public:
    ...
    int sumSubarrayMins(vector<int>& arr) {
        ...
        long long sum=0;//sum of all subarrays minimum element
        const int mod=1e9 + 7;//const,good practise
        for(int i=0;i<arr.size();i++){
            //for each element index,need to find
